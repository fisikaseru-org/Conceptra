...
const NAV_CARDS = [
  ...
  },
  {
    href: '/extraction',
    icon: Binary,
    title: 'Aspect Extractor',
    desc: 'Ekstraksi aspek & entitas (NER & ABSA) dari abstrak penelitian',
    color: '#ec4899',
  ...
  },
  {
    ...
    icon: Search,
    title: 'Gap Finder',
    desc: 'Identifikasi area penelitian yang kurang tersentuh',
    color: '#f59e0b',
  ...
  },
  {
    ...
    desc: 'Telusuri 17.755 artikel penelitian Indonesia dengan filter domain, tahun, dan bahasa',
    color: '#06b6d4',
    gradient: 'from-cyan-600/20 to-cyan-800/5',
  },
  {
    ...
    desc: 'Heatmap temporal, radar multi-dimensi, dan citation impact 12 domain fisika Indonesia',
    color: '#8b5cf6',
    gradient: 'from-purple-600/20 to-purple-800/5',
  },
];
